...
const Skills = () => {
  const skills = [
    ...
    { name: 'MS Excel', color: 'rgba(247, 223, 30, 0.3)' },
    { name: 'Django', color: 'rgba(247, 223, 30, 0.3)' },
    { name: 'React', color: 'rgba(97, 218, 251, 0.3)' },
    { name: 'Power BI', color: 'rgba(55, 118, 171, 0.3)' },
    { name: 'Tableau', color: 'rgba(21, 114, 182, 0.3)' },
    { name: 'HTML5', color: 'rgba(227, 79, 38, 0.3)' },
    { name: 'Pandas', color: 'rgba(227, 79, 38, 0.3)' },
    { name: 'NumPy', color: 'rgba(227, 79, 38, 0.3)' },
    { name: 'Matplotlib', color: 'rgba(227, 79, 38, 0.3)' },
    { name: 'SQL', color: 'rgba(227, 79, 38, 0.3)' },
  ];
