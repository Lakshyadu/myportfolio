...
function Projects() {
  const projects = [
    {title: 'Advanced sales Dashboard',
      description: 'A dashboard for visulazing sales dashboard',
      technologies: ['Python', 'Excel', 'Tailwind','javscript'],
      link:"https://github.com/Lakshyadu/sales-dashboard.git",
      img:"https://imgs.search.brave.com/Bx3yKjObAAycRC5kn9WwTgXPvleMtkwNc3QpyzEh2TQ/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9ibG9n/LmNvdXBsZXIuaW8v/d3AtY29udGVudC91/cGxvYWRzLzIwMjQv/MTEvaW1hZ2UtMTMt/MTAyNHg3MDEucG5n"},
    {
      title: 'Diwali_Sales_Analyses',
      description: 'A analyzing chat for diwali raw data',
      technologies: ['Python', 'Pandas', 'Numpy','matplotlib'],
      link:"https://github.com/Lakshyadu/Diwali_sales_analysiss.git",
      img:"https://i.pinimg.com/1200x/1e/33/74/1e3374d26eb7821e2d04ddfb6fd41689.jpg"
    },
    {
      title: 'Food Ordring Application UI',
      description: 'A simple UI of Food Ordring App',
      technologies: ['React ',"Context-API", ],
      link:"https://github.com/Lakshyadu/food-ordring-Application-UI.git",
      img:"./Data/food.jpg"
    },
    {
      title: 'Note App ',
    ...
    },
    {
      ...
      link:"https://github.com/Lakshyadu/Ai-agent.git",
      img:"./Data/ai new.png"
    },
