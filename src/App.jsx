...
function App() {
  ...
  return (
    ...
    <nav className="navbar sticky top-0 z-50 "id='nav'>
      <div className="logo">Lakshya Dubey</div>
  ...
  <RotatingText
    texts={['Frontend', 'Data Analyst', 'Business Analyst']}
...
<BlurText
  text="Turning data into decisions, and numbers into narratives."
  delay={100}
  animateBy="words"
  direction="top"
...
<div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
        ...
        <a href="data analatics resumeeee.pdf" download className="btn bg-black text-white px-8 py-3 text-lg shadow-md hover:scale-105 transition-transform">
    ...
    <ScrollToTopButton/>
      ...
      <Project/>
        <footer className="bg-base-200 text-black py-6 mt-12 shadow-inner">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 text-center md:text-left">
            <span className="font-bold text-lg">Lakshya Dubey</span>
            <span className="block text-sm">© {new Date().getFullYear()} All rights reserved.</span>
          </div>
          <div className="flex space-x-4">
            <a href="mailto:lakshaydubey9@gmail.com" className="hover:text-primary transition-colors">Email</a>
            <a href="https://www.linkedin.com/in/lakshya-dubey-6a30a428b/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">LinkedIn</a>
            <a href="https://github.com/lakshyadu" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">GitHub</a>
          </div>
        </div>
      </footer>
